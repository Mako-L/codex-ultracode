...
`codex-resources/workflow-runtime`. It does not load an installed workflow plugin,
plugin skills, a plugin checkout, or a global Node installation.

The internal `bin/workflow.mjs bridge` entrypoint preserves the existing native
...
release or installation. The standalone workflow plugin remains a separate
